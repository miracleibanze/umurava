...
const ChallengeDetails: React.FC = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      {/* Project Header */}
      <div className="mb-6">
        <div className="bg-primary py-20 flex items-center justify-center text-white rounded-lg mb-6">
            <img src="/icons/word-logo.svg" alt="Umurava Logo" className="h-100" />
        </div>
